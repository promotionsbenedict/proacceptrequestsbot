...
HELP_TEXT = (
    ...
    "3. The channel activates automatically — new join requests are approved instantly.\n\n"
    ...
    "• Use <b>✅ Approve All Pending</b> on a channel to clear requests received while I am an admin.\n\n"
    "<i>Greeting messages are managed globally by the bot admin.</i>\n\n"
    "<b>Commands</b>\n"
